            ...
            <div class="card">
                <div class="card-body">
                    <div class="section-header">
                        <h4 class="card-title">Tambah Tempat Rekomendasi</h4>
                      </div>
                      <div class="my-3">
                          @if (session('success'))
                      ...
                      <div class="row gx-lg-0 gy-2">
                        <div class="col-lg-12">
                            <form action="{{ url('/prakerin/admin/uploadrekomen') }}" method="post">
                              @csrf
                            <div class="row" >
                            ...
                            <div class="col-md-12 form-group mt-3 mt-md-3">
                              ...
                              <input type="number" class="form-control" name="kuota" id="kuota" min="1" max="10" required>
                            </div>
                            <br>
