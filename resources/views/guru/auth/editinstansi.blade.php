                ...
                <div class="card-body">
                    <div class="section-header">
                      ...
                      <div class="row gx-lg-0 gy-2">
                        <div class="col-lg-12">
                            <form action="{{ url('/prakerin/admin/post-instansi',$data->id) }}" method="post">
                              @csrf
                            <div class="row" >
                              <div class="col-md-6 form-group">
                                <label for="name" class="form-label">Nama Instansi :</label>
                                <input type="text" name="name" class="form-control" id="name" placeholder="Masukan nama instansi ..." value="{{$data->name}}" required>
                              </div>
                              <div class="col-md-6 form-group ">
                            ...
                            <div class="col-md-12 form-group mt-3 mt-md-3">
                                ...
                                <input type="text" class="form-control" name="alamat_instansi" id="alamat_instansi" placeholder="Masukan alamat instansi ..." value="{{$data->alamat_instansi}}" required>
                              </div>
                            <div class="col-md-12 form-group mt-3 mt-md-3">
                            ...
                            <div class="col-md-12 form-group mt-3 mt-md-3">
                              ...
                              <input type="role" class="form-control" name="role" id="role" value="{{$data->role}}" >
                            </div>
                            <br><br>
