                ...
                <div class="card-body">
                    <div class="section-header">
                      ...
                      <div class="row gx-lg-0 gy-2">
                        <div class="col-lg-12">
                            <form action="{{ url('/prakerin/admin/upload-guru') }}" method="post">
                              @csrf
                            <div class="row" >
                            ...
                            <div class="col-md-12 form-group mt-3 mt-md-3">
                              ...
                              <input type="role" class="form-control" name="role" id="role" value="guru" placeholder="Masukan email ..." required>
                            </div>
                            <br><br>
