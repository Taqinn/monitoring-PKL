    ...
    <div class="pagetitle">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Niali Siswa</h5>
                      ...
                      @if ($item->nilai !== 'Sudah dinilai')
                          <tr align="center">
                              ...
                              <td><button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#ExtralargeModal">Beri Nilai</button>
                                <a href="{{ url('/prakerin/admin/give-nilai', $item->id) }}" type="button" class="btn btn-success">Selesai</a></td>
                            </tr>
                            @endif
                            @endforeach
                        </tbody>
                        ...
                        <div class="modal-dialog modal-xl">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('/prakerin/admin/sendnilai',$item->id) }}" class="row g-3" method="POST">
                                    @csrf
                                    <div class="row">
                                        <div class="col-lg-6">
